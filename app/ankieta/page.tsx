          ...
          <div className="flex items-center justify-between">
            <Link href="/" className="flex items-center gap-3 group">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">Ankieta adopcyjna</p>
              </div>
            </Link>
            <ContactButton />
          </div>
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white/80 backdrop-blur rounded-3xl border border-emerald-100 shadow-[0_25px_80px_rgba(45,122,88,0.12)] p-8 md:p-12 mb-8">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-emerald-700 font-medium">Pierwszy krok do adopcji</p>
              </div>
            </div>
          ...
          <div className="bg-white/80 backdrop-blur rounded-3xl border border-emerald-100 shadow-[0_18px_40px_rgba(45,122,88,0.08)] p-8 md:p-12 mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">Wybierz rodzaj zwierzęcia</h2>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              >
                <div className="flex flex-col items-center gap-4">
                  <div className={`w-16 h-16 rounded-2xl flex items-center justify-center ${
                    selectedType === 'dog' ? 'bg-emerald-600' : 'bg-emerald-100'
                  }`}>
                    <Dog className={`w-8 h-8 ${selectedType === 'dog' ? 'text-white' : 'text-emerald-700'}`} />
                  </div>
                  <div className="text-center">
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Pies</h3>
                    <p className="text-sm text-gray-600">Ankieta adopcyjna dla psa</p>
                  </div>
                </div>
              </button>
              ...
              >
                <div className="flex flex-col items-center gap-4">
                  <div className={`w-16 h-16 rounded-2xl flex items-center justify-center ${
                    selectedType === 'cat' ? 'bg-emerald-600' : 'bg-emerald-100'
                  }`}>
                    <Cat className={`w-8 h-8 ${selectedType === 'cat' ? 'text-white' : 'text-emerald-700'}`} />
                  </div>
                  <div className="text-center">
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Kot</h3>
                    <p className="text-sm text-gray-600">Ankieta adopcyjna dla kota</p>
                  </div>
                </div>
              </button>
            </div>
          ...
          {selectedType === 'dog' && (
            <div className="bg-white/80 backdrop-blur rounded-3xl border border-emerald-100 shadow-[0_18px_40px_rgba(45,122,88,0.08)] p-8 md:p-12 mb-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900">Ankieta adopcyjna - Pies</h2>
              </div>
              <iframe
          ...
          {selectedType === 'cat' && (
            <div className="bg-white/80 backdrop-blur rounded-3xl border border-emerald-100 shadow-[0_18px_40px_rgba(45,122,88,0.08)] p-8 md:p-12 mb-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900">Ankieta adopcyjna - Kot</h2>
              </div>
              <iframe
          ...
          {!selectedType && (
            <>
          <div className="bg-white/80 backdrop-blur rounded-3xl border border-emerald-100 shadow-[0_18px_40px_rgba(45,122,88,0.08)] p-8 md:p-12 mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Czego możesz się spodziewać w ankiecie?</h2>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">Warunki mieszkaniowe</h3>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">Skład rodziny</h3>
                  <p className="text-gray-700">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">Doświadczenie ze zwierzętami</h3>
                  <p className="text-gray-700">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">Aspekty finansowe</h3>
                  <p className="text-gray-700">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">Oczekiwania wobec zwierzęcia</h3>
                  <p className="text-gray-700">
          ...
          {/* Important notes */}
          <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-3xl border border-amber-100 p-8 md:p-12 mb-8">
          ...
          <div className="bg-white/80 backdrop-blur rounded-3xl border border-emerald-100 shadow-[0_18px_40px_rgba(45,122,88,0.08)] p-8 md:p-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Proces adopcji krok po kroku</h2>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4 p-4 bg-emerald-50 rounded-xl">
                ...
                <p className="text-gray-800">Odwiedź schronisko i poznaj nasze zwierzęta</p>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 bg-emerald-50 rounded-xl">
                ...
                <p className="text-gray-800">Wypełnij ankietę adopcyjną na miejscu</p>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 bg-emerald-50 rounded-xl">
                ...
                <p className="text-gray-800">Przeprowadzamy rozmowę i ewentualnie wizytę przedadopcyjną</p>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 bg-emerald-50 rounded-xl">
                ...
                <p className="text-gray-800">Podpisujesz umowę adopcyjną</p>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 bg-emerald-50 rounded-xl">
                ...
                <p className="text-gray-800">Zabierasz swojego nowego przyjaciela do domu! 🎉</p>
              </div>
            </div>
          </div>
